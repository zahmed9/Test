...
double fPion_Mom_RotRF;
double fPion_Mom_RotRF_GeV;
double fPion_MomX_RotRF;
double fPion_MomY_RotRF;
double fPion_MomZ_RotRF;
double fPion_Theta_RotRF;
double fPion_Phi_RotRF;
double fPion_MomX_RotRF_GeV;
double fPion_MomY_RotRF_GeV;
double fPion_MomZ_RotRF_GeV;
...
double fy;
double fz;
double fNeutron_Energy_RotRF;
double fNeutron_Energy_RotRF_GeV;
double fNeutron_Mom_RotRF;
double fNeutron_Mom_RotRF_GeV;
double fNeutron_qVec_Theta_RF;
double fNeutron_MomX_RotRF;
double fNeutron_MomY_RotRF;
double fNeutron_MomZ_RotRF;
double fNeutron_Theta_RotRF;
double fNeutron_Phi_RotRF;
double fPhoton_MomX_RF_GeV;
double fPhoton_MomY_RF_GeV;
double fPhoton_MomZ_RF_GeV;
double fNeutron_MomX_RotRF_GeV;
double fNeutron_MomY_RotRF_GeV;
double fNeutron_MomZ_RotRF_GeV;
